...
import {
  initialTransferInFetch as fetch,
...
const mapStateToProps = store => ({
  ...
  list: store.printManagement.initialTransferInData.list,
  paging: store.printManagement.initialTransferInData.paging,
...
function mapDispatchToProps(dispatch) {
  return {
    ...
    export: data => dispatch(exportFunc({ ...data, type: 1 })),
