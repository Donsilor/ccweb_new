...
import { searchDetailList, updateDetailList } from 'redux/modules/selfcar/selfcarCheat';
...
export class AntiDetail extends Component {
      ...
      render: (text, record) => (
        <Fragment>
          <a
            ...
            onClick={() => {
              httpCommonClient
                .post(`/self-car/v1.0/selfAntiCheatingDetail/find/photo/list`, { spotdetailId: record.spotdetailId })
                .then(({ data = {} }) => {
                  this.setState({ photoList: data.data, record, visible: true });
                });
            }}
          >
            查看图片
  ...
  spotHandleExport = () => {
    ...
    httpBufferClient
      .submit(`/self-car/v1.0/selfAntiCheatingDetail/export/detail/list`, { recordId: this.props.match.params.id })
      .then(payload => {
              ...
              <div style={{ display: 'flex', alignItems: 'center', marginBottom: '8px' }}>
                ...
                <div>
                  ...
                  <Radio.Group
                    ...
                    onChange={e => {
                      httpCommonClient.submit('/self-car/v1.0/selfAntiCheatingDetail/updateFileCheating', {
                        id: record.id,
                        fileId: item.file.id,
...
const mapStateToProps = store => ({
  ...
  list: store.selfcarCheat.detail.list,
  paging: store.selfcarCheat.detail.paging,
  query: store.selfcarCheat.detail.query,
});
