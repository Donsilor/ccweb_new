...
import {
  supplementaryTransferInFetch as fetch,
...
const mapStateToProps = store => ({
  ...
  list: store.printManagement.supplementaryTransferInData.list,
  paging: store.printManagement.supplementaryTransferInData.paging,
...
function mapDispatchToProps(dispatch) {
  return {
    ...
    export: data => dispatch(exportFunc({ ...data, type: 2 })),
